...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/managerNew.png" class="img"></a> Pharmacy Management System</h1></div>
<div id="left_column">
<div id="button">
<ul>
    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_manager.php?id=<?php echo $row['manager_id']?>"><img src="images/updateNew.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_manager.php?id=<?php echo $row['manager_id']?>"><img src="images/deleteNew.png" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
